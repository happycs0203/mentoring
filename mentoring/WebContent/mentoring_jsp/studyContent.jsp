			...
			<div class="row">
				<div class="col-md-3 col-md-push-8 animate-box">
					...
					<ul class="contact-info">
						...
						<li><i class="icon-globe2"></i></li></br>				<!-- 데이터베이스 작성자 이름 불러오기 -->
						<li><i class="icon-location4"></i name=""></li>			<!-- 데이터베이스 위치 정보 불러오기 -->
						<li><i class="icon-phone3"></i name=""></li></br></br>	<!-- 데이터베이스 핸드폰 번호 불러오기 -->
						<button>신청하기</button><i>&nbsp</i><i>&nbsp</i>
						<button>찜하기</button><i>&nbsp</i><i>&nbsp</i>
				...
				<div class="col-md-7 col-md-pull-2 animate-box">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<textarea name="" class="form-control" id="" cols="30" rows="7" placeholder="Q&A"></textarea>
							</div>
						</div>
